...
description: >-
  Configure per-model $cacheTtl and $cacheMisses for laravel-auto-cache. Use when
  changing cache lifetime, enabling null/empty miss caching, or aligning TTL
  with config/auto-cache.php.
---
