...
description: >-
  Configure $cacheInvalidates cascade table flushing for laravel-auto-cache.
  Use when a model mutation must clear another table’s query/find caches
  (e.g. Post updates should invalidate users caches used with with('posts')).
---
